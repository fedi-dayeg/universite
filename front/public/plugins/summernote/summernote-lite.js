...
(function (global, factory) {
  ...
  var dropdown = renderer.create('<div class="note-dropdown-menu" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          ...
          var $temp = $('<a class="note-dropdown-item"  href="facke_url" data-value="' + value + '" role="listitem" aria-label="' + value + '"></a>');
  ...
  var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" role="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          var $temp = $('<a class="note-dropdown-item"  href="facke_url" data-value="' + value + '" role="listitem" aria-label="' + item + '"></a>');
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '</div>';
      var footer = [
          '<button type="button"  href="facke_url" class="note-btn note-btn-primary note-video-btn disabled" disabled>',
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '</div>';
      var footer = [
          '<button  href="facke_url" type="button" class="note-btn note-btn-primary note-btn-large note-image-btn disabled" disabled>',
      ...
      var body = '<div class="note-form-group">' +
          ...
          (!opt.disableLinkTarget
              ? '<div class="checkbox">' +
                  ...
                  '</div>' : '');
      var footer = [
          '<button  href="facke_url" type="button" class="note-btn note-btn-primary note-link-btn disabled" disabled>',
